...
(() => {
  const frameSelector = '.hero-film-image, .project-media, .service-entry-media, .label-feature-image, .service-hero-media, .next-project-image, .video-facade, .label-portrait';
