...
Das originale achtsekündige Behind-the-scenes-Video lädt auf der Startseite sofort; auf Studio- und Filmproduktionsseite erst bei Sichtbarkeit. Der Hero besitzt natives `autoplay`, `muted` und `playsinline`. Die Mediensteuerung setzt die zugehörigen Eigenschaften vor jedem Start, übernimmt bereits laufende Wiedergabe und setzt nach einer Seitenrückkehr fort. Eine manuelle Pause bleibt erhalten. Verweigert der Browser Autoplay, bleibt das Standbild mit Play-Regler sichtbar; die nächste geeignete Berührung, ein Klick oder eine Tastatureingabe versucht den sichtbaren Clip direkt innerhalb dieser Interaktion zu starten. Geräteeinstellungen und Regeln eingebetteter Browser können eine solche Interaktion weiterhin voraussetzen. Keine neuen Fotos, Filmprojekte, Referenzen, Kundenstimmen oder Erfolgszahlen wurden erfunden.
